...
from a pull request's base and head commits and maintain a deployment-impact
comment on the pull request. See the [GitHub Action guide](docs/github-action.md)
